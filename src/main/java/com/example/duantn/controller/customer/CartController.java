...
//        model.addAttribute("dsLoaiSP_trongSanPhamCT", dsLoaiSPTrongSanPhamCT);
        ...
        Object sanPhamTrongGioObject = session.getAttribute("totalCartProducts") == null ? 0 : session.getAttribute("totalCartProducts");
        int soLuongSanPhamTrongGio = 0;
        if (sanPhamTrongGioObject instanceof Integer) {
            soLuongSanPhamTrongGio = (Integer) sanPhamTrongGioObject;
        }
